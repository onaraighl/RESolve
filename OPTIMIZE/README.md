...
OPTIMIZE/ is shipped with three .xlsx files.

`data_johnstown.xlsx` is the master spreadsheet, from which the other spreadsheets are derived.  The last tab may be of interest.  In this tab,  SK has inferred the Van Genuchten parameters for the soils at Johnstown Castle using the data in the paper of Diamond and Sills, and ROSETTA. 
